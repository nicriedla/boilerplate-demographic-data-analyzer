...
def calculate_demographic_data(print_data=True):
    ...
    country_rich_percentage = (country_rich / country_counts * 100).round(1)
    ...
    top_IN_occupation = df[(df["native-country"] == "India") & (df["salary"] == ">50K")]["occupation"].mode()[0] if not df[(df["native-country"] == "India") & (df["salary"] == ">50K")]["occupation"].mode().empty else None
